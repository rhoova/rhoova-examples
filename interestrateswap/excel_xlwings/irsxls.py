...
def getinputs(wb):
    ...
    if receiveleg == 'Fixed':
        ...
        floatingLegdefinition['maturityDayConvention'] = inputsheet.range('paylegmatdayconv').value
        ...
        floatingLegdefinition['maturityDayConvention'] = inputsheet.range('receivelegmatdayconv').value
        ...
        fixedLegdefinition['maturityDayConvention'] = inputsheet.range('paylegmatdayconv').value
